...
class TransactionControllerTest {
  ...
  class 성공 {
    ...
    void 내역_생성() throws Exception {
      ...
      final RequestCreateTransactionDto requestCreateTransactionDto = new RequestCreateTransactionDto(1L, now, "테스트 이벤트", amount, category, "테스트 메모");
      
      final ObjectMapper mapper = new ObjectMapper()
          .registerModule(new JavaTimeModule())
          .disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
      final String json = mapper.writeValueAsString(requestCreateTransactionDto);
